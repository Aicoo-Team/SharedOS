...
| File                                    | Purpose                                                |
| --------------------------------------- | ------------------------------------------------------ |
| `packages/debugger/src/diagnose.ts`     | Core diagnoser: `diagnoseDenial()` + `diagnoseBatch()` |
| `packages/debugger/src/diagnose.test.ts`| 25 tests                                               |
| `packages/debugger/src/index.ts`        | Public exports                                         |
