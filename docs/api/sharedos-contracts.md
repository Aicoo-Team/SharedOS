...
Defined in: [execution.ts:94](https://github.com/Aicoo-Team/SharedOS/blob/main/packages/contracts/src/execution.ts#L94)
...
Defined in: [execution.ts:57](https://github.com/Aicoo-Team/SharedOS/blob/main/packages/contracts/src/execution.ts#L57)
...
Defined in: [execution.ts:24](https://github.com/Aicoo-Team/SharedOS/blob/main/packages/contracts/src/execution.ts#L24)
...
Defined in: [execution.ts:41](https://github.com/Aicoo-Team/SharedOS/blob/main/packages/contracts/src/execution.ts#L41)
...
Defined in: [execution.ts:130](https://github.com/Aicoo-Team/SharedOS/blob/main/packages/contracts/src/execution.ts#L130)

---

### ExecutionSettlement

> **ExecutionSettlement** = `z.infer`\<_typeof_ [`ExecutionSettlementSchema`](#executionsettlementschema)>\>

Defined in: [settlement.ts:131](https://github.com/Aicoo-Team/SharedOS/blob/main/packages/contracts/src/settlement.ts#L131)
...
> **OperationSettlement** = `z.infer`\<_typeof_ [`OperationSettlementSchema`](#operationsettlementschema)>\>

Defined in: [settlement.ts:65](https://github.com/Aicoo-Team/SharedOS/blob/main/packages/contracts/src/settlement.ts#L65)
...
### ToolResultIngestionAck

> **ToolResultIngestionAck** = `z.infer`\<_typeof_ [`ToolResultIngestionAckSchema`](#toolresultingestionackschema)>\>

Defined in: [settlement.ts:16](https://github.com/Aicoo-Team/SharedOS/blob/main/packages/contracts/src/settlement.ts#L16)

---

### ToolResultIngestionEnvelope

> **ToolResultIngestionEnvelope** = `z.infer`\<_typeof_ [`ToolResultIngestionEnvelopeSchema`](#toolresultingestionenvelopeschema)>\>

Defined in: [settlement.ts:34](https://github.com/Aicoo-Team/SharedOS/blob/main/packages/contracts/src/settlement.ts#L34)
...
Defined in: [execution.ts:71](https://github.com/Aicoo-Team/SharedOS/blob/main/packages/contracts/src/execution.ts#L71)
...
Defined in: [execution.ts:44](https://github.com/Aicoo-Team/SharedOS/blob/main/packages/contracts/src/execution.ts#L44)
...
Defined in: [execution.ts:16](https://github.com/Aicoo-Team/SharedOS/blob/main/packages/contracts/src/execution.ts#L16)
...
Defined in: [execution.ts:27](https://github.com/Aicoo-Team/SharedOS/blob/main/packages/contracts/src/execution.ts#L27)
...
> `const` **ExecutionResultSchema**: `ZodDiscriminatedUnion`\<`"status"`, \[`ZodObject`\<`object` & `object`, `"strict"`, `ZodTypeAny`, \{ `completedAt`: `string`; `events`: `object`[]; `executionId`: `string`; `metadata?`: [`JsonObject`](#jsonobject); `output`: [`JsonValue`](#jsonvalue); `settlement?`: \{ `history`: \{ `cleanup`: `"failed"` \| `"pending"` \| `"unsupported"` \| `"completed"`; `finish`: `"failed"` \| `"pending"` \| `"unsupported"` \| `"completed"`; \}; `operations`: `object`[]; `pendingOperationIds`: `string`[]; `pendingWorkIds`: `string`[]; `status`: `"unsupported"` \| `"settled"` \| `"incomplete"`; `version`: `"1"`; \}; `startedAt`: `string`; `status`: `"succeeded"`; `traceId`: `string`; `version`: `"1"`; \}, \{ `completedAt`: `string`; `events`: `object`[]; `executionId`: `string`; `metadata?`: [`JsonObject`](#jsonobject); `output`: [`JsonValue`](#jsonvalue); `settlement?`: \{ `history`: \{ `cleanup`: `"failed"` \| `"pending"` \| `"unsupported"` \| `"completed"`; `finish`: `"failed"` \| `"pending"` \| `"unsupported"` \| `"completed"`; \}; `operations`: `object`[]; `pendingOperationIds`: `string`[]; `pendingWorkIds`: `string`[]; `status`: `"unsupported"` \| `"settled"` \| `"incomplete"`; `version`: `"1"`; \}; `startedAt`: `string`; `status`: `"succeeded"`; `traceId`: `string`; `version`: `"1"`; \}\>, `ZodObject`\<`object` & `object`, `"strict"`, `ZodTypeAny`, \{ `completedAt`: `string`; `error`: \{ `code`: `string`; `details?`: [`JsonObject`](#jsonobject); `message`: `string`; `retryable?`: `boolean`; \}; `events`: `object`[]; `executionId`: `string`; `metadata?`: [`JsonObject`](#jsonobject); `settlement?`: \{ `history`: \{ `cleanup`: `"failed"` \| `"pending"` \| `"unsupported"` \| `"completed"`; `finish`: `"failed"` \| `"pending"` \| `"unsupported"` \| `"completed"`; \}; `operations`: `object`[]; `pendingOperationIds`: `string`[]; `pendingWorkIds`: `string`[]; `status`: `"unsupported"` \| `"settled"` \| `"incomplete"`; `version`: `"1"`; \}; `startedAt`: `string`; `status`: `"denied"`; `traceId`: `string`; `version`: `"1"`; \}, \{ `completedAt`: `string`; `error`: \{ `code`: `string`; `details?`: [`JsonObject`](#jsonobject); `message`: `string`; `retryable?`: `boolean`; \}; `events`: `object`[]; `executionId`: `string`; `metadata?`: [`JsonObject`](#jsonobject); `settlement?`: \{ `history`: \{ `cleanup`: `"failed"` \| `"pending"` \| `"unsupported"` \| `"completed"`; `finish`: `"failed"` \| `"pending"` \| `"unsupported"` \| `"completed"`; \}; `operations`: `object`[]; `pendingOperationIds`: `string`[]; `pendingWorkIds`: `string`[]; `status`: `"unsupported"` \| `"settled"` \| `"incomplete"`; `version`: `"1"`; \}; `startedAt`: `string`; `status`: `"denied"`; `traceId`: `string`; `version`: `"1"`; \}\>, `ZodObject`\<`object` & `object`, `"strict"`, `ZodTypeAny`, \{ `completedAt`: `string`; `error`: \{ `code`: `string`; `details?`: [`JsonObject`](#jsonobject); `message`: `string`; `retryable?`: `boolean`; \}; `events`: `object`[]; `executionId`: `string`; `metadata?`: [`JsonObject`](#jsonobject); `settlement?`: \{ `history`: \{ `cleanup`: `"failed"` \| `"pending"` \| `"unsupported"` \| `"completed"`; `finish`: `"failed"` \| `"pending"` \| `"unsupported"` \| `"completed"`; \}; `operations`: `object`[]; `pendingOperationIds`: `string`[]; `pendingWorkIds`: `string`[]; `status`: `"unsupported"` \| `"settled"` \| `"incomplete"`; `version`: `"1"`; \}; `startedAt`: `string`; `status`: `"failed"`; `traceId`: `string`; `version`: `"1"`; \}, \{ `completedAt`: `string`; `error`: \{ `code`: `string`; `details?`: [`JsonObject`](#jsonobject); `message`: `string`; `retryable?`: `boolean`; \}; `events`: `object`[]; `executionId`: `string`; `metadata?`: [`JsonObject`](#jsonobject); `settlement?`: \{ `history`: \{ `cleanup`: `"failed"` \| `"pending"` \| `"unsupported"` \| `"completed"`; `finish`: `"failed"` \| `"pending"` \| `"unsupported"` \| `"completed"`; \}; `operations`: `object`[]; `pendingOperationIds`: `string`[]; `pendingWorkIds`: `string`[]; `status`: `"unsupported"` \| `"settled"` \| `"incomplete"`; `version`: `"1"`; \}; `startedAt`: `string`; `status`: `"failed"`; `traceId`: `string`; `version`: `"1"`; \}\>, `ZodObject`\<`object` & `object`, `"strict"`, `ZodTypeAny`, \{ `completedAt`: `string`; `error?`: \{ `code`: `string`; `details?`: [`JsonObject`](#jsonobject); `message`: `string`; `retryable?`: `boolean`; \}; `events`: `object`[]; `executionId`: `string`; `metadata?`: [`JsonObject`](#jsonobject); `settlement?`: \{ `history`: \{ `cleanup`: `"failed"` \| `"pending"` \| `"unsupported"` \| `"completed"`; `finish`: `"failed"` \| `"pending"` \| `"unsupported"` \| `"completed"`; \}; `operations`: `object`[]; `pendingOperationIds`: `string`[]; `pendingWorkIds`: `string`[]; `status`: `"unsupported"` \| `"settled"` \| `"incomplete"`; `version`: `"1"`; \}; `startedAt`: `string`; `status`: `"cancelled"`; `traceId`: `string`; `version`: `"1"`; \}, \{ `completedAt`: `string`; `error?`: \{ `code`: `string`; `details?`: [`JsonObject`](#jsonobject); `message`: `string`; `retryable?`: `boolean`; \}; `events`: `object`[]; `executionId`: `string`; `metadata?`: [`JsonObject`](#jsonobject); `settlement?`: \{ `history`: \{ `cleanup`: `"failed"` \| `"pending"` \| `"unsupported"` \| `"completed"`; `finish`: `"failed"` \| `"pending"` \| `"unsupported"` \| `"completed"`; \}; `operations`: `object`[]; `pendingOperationIds`: `string`[]; `pendingWorkIds`: `string`[]; `status`: `"unsupported"` \| `"settled"` \| `"incomplete"`; `version`: `"1"`; \}; `startedAt`: `string`; `status`: `"cancelled"`; `traceId`: `string`; `version`: `"1"`; \}\>, `ZodObject`\<`object` & `object`, `"strict"`, `ZodTypeAny`, \{ `completedAt`: `string`; `escalation`: \{ `reason`: `string`; `requestedAt`: `string`; `requestedAuthority?`: \{ `capabilities`: `object`[]; `constraints?`: \{ `delegationDepth?`: `number`; `expiresAt?`: `string`; `maxUses?`: `number`; `notBefore?`: `string`; `purposes?`: ...[]; \}; `id`: `string`; `metadata?`: [`JsonObject`](#jsonobject); `namespaceId`: `string`; `owner`: \{ `kind`: `"human"`; `userId`: `string`; \} \| \{ `agentId`: `string`; `kind`: `"agent"`; \} \| \{ `conversationId`: `string`; `kind`: `"group"`; \} \| \{ `kind`: `"service"`; `serviceId`: `string`; \}; `purpose`: `string`; `requestedAt`: `string`; `requester`: \{ `kind`: `"human"`; `userId`: `string`; \} \| \{ `agentId`: `string`; `kind`: `"agent"`; \} \| \{ `conversationId`: `string`; `kind`: `"group"`; \} \| \{ `kind`: `"service"`; `serviceId`: `string`; \}; \}; `reviewer`: \{ `kind`: `"human"`; `userId`: `string`; \} \| \{ `agentId`: `string`; `kind`: `"agent"`; \} \| \{ `conversationId`: `string`; `kind`: `"group"`; \} \| \{ `kind`: `"service"`; `serviceId`: `string`; \}; `status`: `"pending"`; \}; `events`: `object`[]; `executionId`: `string`; `metadata?`: [`JsonObject`](#jsonobject); `settlement?`: \{ `history`: \{ `cleanup`: `"failed"` \| `"pending"` \| `"unsupported"` \| `"completed"`; `finish`: `"failed"` \| `"pending"` \| `"unsupported"` \| `"completed"`; \}; `operations`: `object`[]; `pendingOperationIds`: `string`[]; `pendingWorkIds`: `string`[]; `status`: `"unsupported"` \| `"settled"` \| `"incomplete"`; `version`: `"1"`; \}; `startedAt`: `string`; `status`: `"escalated"`; `traceId`: `string`; `version`: `"1"`; \}, \{ `completedAt`: `string`; `escalation`: \{ `reason`: `string`; `requestedAt`: `string`; `requestedAuthority?`: \{ `capabilities`: `object`[]; `constraints?`: \{ `delegationDepth?`: `number`; `expiresAt?`: `string`; `maxUses?`: `number`; `notBefore?`: `string`; `purposes?`: ...[]; \}; `id`: `string`; `metadata?`: [`JsonObject`](#jsonobject); `namespaceId`: `string`; `owner`: \{ `kind`: `"human"`; `userId`: `string`; \} \| \{ `agentId`: `string`; `kind`: `"agent"`; \} \| \{ `conversationId`: `string`; `kind`: `"group"`; \} \| \{ `kind`: `"service"`; `serviceId`: `string`; \}; `purpose`: `string`; `requestedAt`: `string`; `requester`: \{ `kind`: `"human"`; `userId`: `string`; \} \| \{ `agentId`: `string`; `kind`: `"agent"`; \} \| \{ `conversationId`: `string`; `kind`: `"group"`; \} \| \{ `kind`: `"service"`; `serviceId`: `string`; \}; \}; `reviewer`: \{ `kind`: `"human"`; `userId`: `string`; \} \| \{ `agentId`: `string`; `kind`: `"agent"`; \} \| \{ `conversationId`: `string`; `kind`: `"group"`; \} \| \{ `kind`: `"service"`; `serviceId`: `string`; \}; `status`: `"pending"`; \}; `events`: `object`[]; `executionId`: `string`; `metadata?`: [`JsonObject`](#jsonobject); `settlement?`: \{ `history`: \{ `cleanup`: `"failed"` \| `"pending"` \| `"unsupported"` \| `"completed"`; `finish`: `"failed"` \| `"pending"` \| `"unsupported"` \| `"completed"`; \}; `operations`: `object`[]; `pendingOperationIds`: `string`[]; `pendingWorkIds`: `string`[]; `status`: `"unsupported"` \| `"settled"` \| `"incomplete"`; `version`: `"1"`; \}; `startedAt`: `string`; `status`: `"escalated"`; `traceId`: `string`; `version`: `"1"`; \}\>\]\>

Defined in: [execution.ts:107](https://github.com/Aicoo-Team/SharedOS/blob/main/packages/contracts/src/execution.ts#L107)

---

### ExecutionSettlementSchema

> `const` **ExecutionSettlementSchema**: `ZodEffects`\<`ZodObject`\<\{ `history`: `ZodObject`\<\{ `cleanup`: `ZodEnum`\<\[`"completed"`, `"pending"`, `"failed"`, `"unsupported"`\]\>; `finish`: `ZodEnum`\<\[`"completed"`, `"pending"`, `"failed"`, `"unsupported"`\]\>; \}, `"strict"`, `ZodTypeAny`, \{ `cleanup`: `"failed"` \| `"pending"` \| `"unsupported"` \| `"completed"`; `finish`: `"failed"` \| `"pending"` \| `"unsupported"` \| `"completed"`; \}, \{ `cleanup`: `"failed"` \| `"pending"` \| `"unsupported"` \| `"completed"`; `finish`: `"failed"` \| `"pending"` \| `"unsupported"` \| `"completed"`; \}\>; `operations`: `ZodArray`\<`ZodEffects`\<`ZodObject`\<\{ `audit`: `ZodEnum`\<\[`"recorded"`, `"failed"`, `"pending"`, `"unknown"`\]\>; `callId`: `ZodString`; `ingestion`: `ZodEnum`\<\[`"acknowledged"`, `"pending"`, `"failed"`, `"unsupported"`\]\>; `result`: `ZodEnum`\<\[`"ready"`, `"pending"`, `"failed"`\]\>; `resultDigest`: `ZodOptional`\<`ZodString`>\>; `tool`: `ZodString`; \}, `"strict"`, `ZodTypeAny`, \{ `audit`: `"unknown"` \| `"failed"` \| `"pending"` \| `"recorded"`; `callId`: `string`; `ingestion`: `"failed"` \| `"pending"` \| `"acknowledged"` \| `"unsupported"`; `result`: `"failed"` \| `"ready"` \| `"pending"`; `resultDigest?`: `string`; `tool`: `string`; \}, \{ `audit`: `"unknown"` \| `"failed"` \| `"pending"` \| `"recorded"`; `callId`: `string`; `ingestion`: `"failed"` \| `"pending"` \| `"acknowledged"` \| `"unsupported"`; `result`: `"failed"` \| `"ready"` \| `"pending"`; `resultDigest?`: `string`; `tool`: `string`; \}\>, \{ `audit`: `"unknown"` \| `"failed"` \| `"pending"` \| `"recorded"`; `callId`: `string`; `ingestion`: `"failed"` \| `"pending"` \| `"acknowledged"` \| `"unsupported"`; `result`: `"failed"` \| `"ready"` \| `"pending"`; `resultDigest?`: `string`; `tool`: `string`; \}, \{ `audit`: `"unknown"` \| `"failed"` \| `"pending"` \| `"recorded"`; `callId`: `string`; `ingestion`: `"failed"` \| `"pending"` \| `"acknowledged"` \| `"unsupported"`; `result`: `"failed"` \| `"ready"` \| `"pending"`; `resultDigest?`: `string`; `tool`: `string`; \}\>, `"many"`>\>; `pendingOperationIds`: `ZodArray`\<`ZodString`, `"many"`>\>; `pendingWorkIds`: `ZodArray`\<`ZodString`, `"many"`>\>; `status`: `ZodEnum`\<\[`"settled"`, `"incomplete"`, `"unsupported"`\]\>; `version`: `ZodLiteral`\<`"1"`>\>; \}, `"strict"`, `ZodTypeAny`, \{ `history`: \{ `cleanup`: `"failed"` \| `"pending"` \| `"unsupported"` \| `"completed"`; `finish`: `"failed"` \| `"pending"` \| `"unsupported"` \| `"completed"`; \}; `operations`: `object`[]; `pendingOperationIds`: `string`[]; `pendingWorkIds`: `string`[]; `status`: `"unsupported"` \| `"settled"` \| `"incomplete"`; `version`: `"1"`; \}, \{ `history`: \{ `cleanup`: `"failed"` \| `"pending"` \| `"unsupported"` \| `"completed"`; `finish`: `"failed"` \| `"pending"` \| `"unsupported"` \| `"completed"`; \}; `operations`: `object`[]; `pendingOperationIds`: `string`[]; `pendingWorkIds`: `string`[]; `status`: `"unsupported"` \| `"settled"` \| `"incomplete"`; `version`: `"1"`; \}\>, \{ `history`: \{ `cleanup`: `"failed"` \| `"pending"` \| `"unsupported"` \| `"completed"`; `finish`: `"failed"` \| `"pending"` \| `"unsupported"` \| `"completed"`; \}; `operations`: `object`[]; `pendingOperationIds`: `string`[]; `pendingWorkIds`: `string`[]; `status`: `"unsupported"` \| `"settled"` \| `"incomplete"`; `version`: `"1"`; \}, \{ `history`: \{ `cleanup`: `"failed"` \| `"pending"` \| `"unsupported"` \| `"completed"`; `finish`: `"failed"` \| `"pending"` \| `"unsupported"` \| `"completed"`; \}; `operations`: `object`[]; `pendingOperationIds`: `string`[]; `pendingWorkIds`: `string`[]; `status`: `"unsupported"` \| `"settled"` \| `"incomplete"`; `version`: `"1"`; \}\>

Defined in: [settlement.ts:69](https://github.com/Aicoo-Team/SharedOS/blob/main/packages/contracts/src/settlement.ts#L69)
...
> `const` **OperationSettlementSchema**: `ZodEffects`\<`ZodObject`\<\{ `audit`: `ZodEnum`\<\[`"recorded"`, `"failed"`, `"pending"`, `"unknown"`\]\>; `callId`: `ZodString`; `ingestion`: `ZodEnum`\<\[`"acknowledged"`, `"pending"`, `"failed"`, `"unsupported"`\]\>; `result`: `ZodEnum`\<\[`"ready"`, `"pending"`, `"failed"`\]\>; `resultDigest`: `ZodOptional`\<`ZodString`>\>; `tool`: `ZodString`; \}, `"strict"`, `ZodTypeAny`, \{ `audit`: `"unknown"` \| `"failed"` \| `"pending"` \| `"recorded"`; `callId`: `string`; `ingestion`: `"failed"` \| `"pending"` \| `"acknowledged"` \| `"unsupported"`; `result`: `"failed"` \| `"ready"` \| `"pending"`; `resultDigest?`: `string`; `tool`: `string`; \}, \{ `audit`: `"unknown"` \| `"failed"` \| `"pending"` \| `"recorded"`; `callId`: `string`; `ingestion`: `"failed"` \| `"pending"` \| `"acknowledged"` \| `"unsupported"`; `result`: `"failed"` \| `"ready"` \| `"pending"`; `resultDigest?`: `string`; `tool`: `string`; \}\>, \{ `audit`: `"unknown"` \| `"failed"` \| `"pending"` \| `"recorded"`; `callId`: `string`; `ingestion`: `"failed"` \| `"pending"` \| `"acknowledged"` \| `"unsupported"`; `result`: `"failed"` \| `"ready"` \| `"pending"`; `resultDigest?`: `string`; `tool`: `string`; \}, \{ `audit`: `"unknown"` \| `"failed"` \| `"pending"` \| `"recorded"`; `callId`: `string`; `ingestion`: `"failed"` \| `"pending"` \| `"acknowledged"` \| `"unsupported"`; `result`: `"failed"` \| `"ready"` \| `"pending"`; `resultDigest?`: `string`; `tool`: `string`; \}\>

Defined in: [settlement.ts:36](https://github.com/Aicoo-Team/SharedOS/blob/main/packages/contracts/src/settlement.ts#L36)
...
> `const` **ToolResultIngestionAckSchema**: `ZodObject`\<\{ `callId`: `ZodString`; `executionId`: `ZodString`; `resultDigest`: `ZodString`; `tool`: `ZodString`; `traceId`: `ZodString`; `version`: `ZodLiteral`\<`"1"`>\>; \}, `"strict"`, `ZodTypeAny`, \{ `callId`: `string`; `executionId`: `string`; `resultDigest`: `string`; `tool`: `string`; `traceId`: `string`; `version`: `"1"`; \}, \{ `callId`: `string`; `executionId`: `string`; `resultDigest`: `string`; `tool`: `string`; `traceId`: `string`; `version`: `"1"`; \}\>

Defined in: [settlement.ts:6](https://github.com/Aicoo-Team/SharedOS/blob/main/packages/contracts/src/settlement.ts#L6)
...
> `const` **ToolResultIngestionEnvelopeSchema**: `ZodEffects`\<`ZodObject`\<`object` & `object`, `"strict"`, `ZodTypeAny`, \{ `callId`: `string`; `executionId`: `string`; `result`: \{ `callId`: `string`; `completedAt`: `string`; `metadata?`: [`JsonObject`](#jsonobject); `output`: [`JsonValue`](#jsonvalue); `status`: `"succeeded"`; `tool`: `string`; \} \| \{ `callId`: `string`; `completedAt`: `string`; `error`: \{ `code`: `string`; `details?`: [`JsonObject`](#jsonobject); `message`: `string`; `retryable?`: `boolean`; \}; `metadata?`: [`JsonObject`](#jsonobject); `status`: `"denied"`; `tool`: `string`; \} \| \{ `callId`: `string`; `completedAt`: `string`; `error`: \{ `code`: `string`; `details?`: [`JsonObject`](#jsonobject); `message`: `string`; `retryable?`: `boolean`; \}; `metadata?`: [`JsonObject`](#jsonobject); `status`: `"failed"`; `tool`: `string`; \}; `resultDigest`: `string`; `tool`: `string`; `traceId`: `string`; `version`: `"1"`; \}, \{ `callId`: `string`; `executionId`: `string`; `result`: \{ `callId`: `string`; `completedAt`: `string`; `metadata?`: [`JsonObject`](#jsonobject); `output`: [`JsonValue`](#jsonvalue); `status`: `"succeeded"`; `tool`: `string`; \} \| \{ `callId`: `string`; `completedAt`: `string`; `error`: \{ `code`: `string`; `details?`: [`JsonObject`](#jsonobject); `message`: `string`; `retryable?`: `boolean`; \}; `metadata?`: [`JsonObject`](#jsonobject); `status`: `"denied"`; `tool`: `string`; \} \| \{ `callId`: `string`; `completedAt`: `string`; `error`: \{ `code`: `string`; `details?`: [`JsonObject`](#jsonobject); `message`: `string`; `retryable?`: `boolean`; \}; `metadata?`: [`JsonObject`](#jsonobject); `status`: `"failed"`; `tool`: `string`; \}; `resultDigest`: `string`; `tool`: `string`; `traceId`: `string`; `version`: `"1"`; \}\>, \{ `callId`: `string`; `executionId`: `string`; `result`: \{ `callId`: `string`; `completedAt`: `string`; `metadata?`: [`JsonObject`](#jsonobject); `output`: [`JsonValue`](#jsonvalue); `status`: `"succeeded"`; `tool`: `string`; \} \| \{ `callId`: `string`; `completedAt`: `string`; `error`: \{ `code`: `string`; `details?`: [`JsonObject`](#jsonobject); `message`: `string`; `retryable?`: `boolean`; \}; `metadata?`: [`JsonObject`](#jsonobject); `status`: `"denied"`; `tool`: `string`; \} \| \{ `callId`: `string`; `completedAt`: `string`; `error`: \{ `code`: `string`; `details?`: [`JsonObject`](#jsonobject); `message`: `string`; `retryable?`: `boolean`; \}; `metadata?`: [`JsonObject`](#jsonobject); `status`: `"failed"`; `tool`: `string`; \}; `resultDigest`: `string`; `tool`: `string`; `traceId`: `string`; `version`: `"1"`; \}, \{ `callId`: `string`; `executionId`: `string`; `result`: \{ `callId`: `string`; `completedAt`: `string`; `metadata?`: [`JsonObject`](#jsonobject); `output`: [`JsonValue`](#jsonvalue); `status`: `"succeeded"`; `tool`: `string`; \} \| \{ `callId`: `string`; `completedAt`: `string`; `error`: \{ `code`: `string`; `details?`: [`JsonObject`](#jsonobject); `message`: `string`; `retryable?`: `boolean`; \}; `metadata?`: [`JsonObject`](#jsonobject); `status`: `"denied"`; `tool`: `string`; \} \| \{ `callId`: `string`; `completedAt`: `string`; `error`: \{ `code`: `string`; `details?`: [`JsonObject`](#jsonobject); `message`: `string`; `retryable?`: `boolean`; \}; `metadata?`: [`JsonObject`](#jsonobject); `status`: `"failed"`; `tool`: `string`; \}; `resultDigest`: `string`; `tool`: `string`; `traceId`: `string`; `version`: `"1"`; \}\>

Defined in: [settlement.ts:19](https://github.com/Aicoo-Team/SharedOS/blob/main/packages/contracts/src/settlement.ts#L19)
