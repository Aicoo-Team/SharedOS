...
Defined in: [settlement.ts:50](https://github.com/Aicoo-Team/SharedOS/blob/main/packages/contracts/src/settlement.ts#L50)
...
Defined in: [settlement.ts:21](https://github.com/Aicoo-Team/SharedOS/blob/main/packages/contracts/src/settlement.ts#L21)
...
> `const` **ExecutionSettlementSchema**: `ZodObject`\<\{ `history`: `ZodObject`\<\{ `cleanup`: `ZodEnum`\<\[`"completed"`, `"pending"`, `"failed"`, `"unsupported"`\]\>; `finish`: `ZodEnum`\<\[`"completed"`, `"pending"`, `"failed"`, `"unsupported"`\]\>; \}, `"strict"`, `ZodTypeAny`, \{ `cleanup`: `"failed"` \| `"pending"` \| `"unsupported"` \| `"completed"`; `finish`: `"failed"` \| `"pending"` \| `"unsupported"` \| `"completed"`; \}, \{ `cleanup`: `"failed"` \| `"pending"` \| `"unsupported"` \| `"completed"`; `finish`: `"failed"` \| `"pending"` \| `"unsupported"` \| `"completed"`; \}\>; `operations`: `ZodArray`\<`ZodObject`\<\{ `audit`: `ZodEnum`\<\[`"recorded"`, `"failed"`, `"pending"`, `"unknown"`\]\>; `callId`: `ZodString`; `ingestion`: `ZodEnum`\<\[`"acknowledged"`, `"pending"`, `"failed"`, `"unsupported"`\]\>; `result`: `ZodEnum`\<\[`"ready"`, `"pending"`, `"failed"`\]\>; `resultDigest`: `ZodOptional`\<`ZodString`>\>; `tool`: `ZodString`; \}, `"strict"`, `ZodTypeAny`, \{ `audit`: `"unknown"` \| `"failed"` \| `"pending"` \| `"recorded"`; `callId`: `string`; `ingestion`: `"failed"` \| `"pending"` \| `"acknowledged"` \| `"unsupported"`; `result`: `"failed"` \| `"ready"` \| `"pending"`; `resultDigest?`: `string`; `tool`: `string`; \}, \{ `audit`: `"unknown"` \| `"failed"` \| `"pending"` \| `"recorded"`; `callId`: `string`; `ingestion`: `"failed"` \| `"pending"` \| `"acknowledged"` \| `"unsupported"`; `result`: `"failed"` \| `"ready"` \| `"pending"`; `resultDigest?`: `string`; `tool`: `string`; \}\>, `"many"`>\>; `pendingOperationIds`: `ZodArray`\<`ZodString`, `"many"`>\>; `pendingWorkIds`: `ZodArray`\<`ZodString`, `"many"`>\>; `status`: `ZodEnum`\<\[`"settled"`, `"incomplete"`, `"unsupported"`\]\>; `version`: `ZodLiteral`\<`"1"`>\>; \}, `"strict"`, `ZodTypeAny`, \{ `history`: \{ `cleanup`: `"failed"` \| `"pending"` \| `"unsupported"` \| `"completed"`; `finish`: `"failed"` \| `"pending"` \| `"unsupported"` \| `"completed"`; \}; `operations`: `object`[]; `pendingOperationIds`: `string`[]; `pendingWorkIds`: `string`[]; `status`: `"unsupported"` \| `"settled"` \| `"incomplete"`; `version`: `"1"`; \}, \{ `history`: \{ `cleanup`: `"failed"` \| `"pending"` \| `"unsupported"` \| `"completed"`; `finish`: `"failed"` \| `"pending"` \| `"unsupported"` \| `"completed"`; \}; `operations`: `object`[]; `pendingOperationIds`: `string`[]; `pendingWorkIds`: `string`[]; `status`: `"unsupported"` \| `"settled"` \| `"incomplete"`; `version`: `"1"`; \}\>

Defined in: [settlement.ts:40](https://github.com/Aicoo-Team/SharedOS/blob/main/packages/contracts/src/settlement.ts#L40)
...
> `const` **OperationSettlementSchema**: `ZodObject`\<\{ `audit`: `ZodEnum`\<\[`"recorded"`, `"failed"`, `"pending"`, `"unknown"`\]\>; `callId`: `ZodString`; `ingestion`: `ZodEnum`\<\[`"acknowledged"`, `"pending"`, `"failed"`, `"unsupported"`\]\>; `result`: `ZodEnum`\<\[`"ready"`, `"pending"`, `"failed"`\]\>; `resultDigest`: `ZodOptional`\<`ZodString`>\>; `tool`: `ZodString`; \}, `"strict"`, `ZodTypeAny`, \{ `audit`: `"unknown"` \| `"failed"` \| `"pending"` \| `"recorded"`; `callId`: `string`; `ingestion`: `"failed"` \| `"pending"` \| `"acknowledged"` \| `"unsupported"`; `result`: `"failed"` \| `"ready"` \| `"pending"`; `resultDigest?`: `string`; `tool`: `string`; \}, \{ `audit`: `"unknown"` \| `"failed"` \| `"pending"` \| `"recorded"`; `callId`: `string`; `ingestion`: `"failed"` \| `"pending"` \| `"acknowledged"` \| `"unsupported"`; `result`: `"failed"` \| `"ready"` \| `"pending"`; `resultDigest?`: `string`; `tool`: `string`; \}\>

Defined in: [settlement.ts:23](https://github.com/Aicoo-Team/SharedOS/blob/main/packages/contracts/src/settlement.ts#L23)
