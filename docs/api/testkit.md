...
[SharedOS API](README.md) / @sharedos/testkit
...
| ------------------------------------- | ---------- | ------------------------------------ | ------------- | ------------------------------------------------------------------------------------------------------------- |
| <a id="property-events"></a> `events` | `readonly` | [`AuditEvent`](core.md#auditevent)[] | `[]`          | [testkit/src/index.ts:27](https://github.com/Aicoo-Team/SharedOS/blob/main/packages/testkit/src/index.ts#L27) |
...
| Parameter | Type                               |
| --------- | ---------------------------------- |
| `event`   | [`AuditEvent`](core.md#auditevent) |
...
[`AuditSink`](core.md#auditsink).[`record`](core.md#record-2)
...
- [`MessageTransport`](core.md#messagetransport)
...
[`MessageTransport`](core.md#messagetransport).[`deliver`](core.md#deliver)
...
- [`ResourceProvider`](core.md#resourceprovider)
...
> **invoke**(`operation`): `Promise`\<\{ `completedAt`: `string`; `metadata?`: [`JsonObject`](contracts.md#jsonobject); `operationId`: `string`; `output`: [`JsonValue`](contracts.md#jsonvalue); `status`: `"succeeded"`; \} \| \{ `completedAt`: `string`; `error`: \{ `code`: `string`; `details?`: [`JsonObject`](contracts.md#jsonobject); `message`: `string`; `retryable?`: `boolean`; \}; `metadata?`: [`JsonObject`](contracts.md#jsonobject); `operationId`: `string`; `status`: `"denied"`; \} \| \{ `completedAt`: `string`; `error`: \{ `code`: `string`; `details?`: [`JsonObject`](contracts.md#jsonobject); `message`: `string`; `retryable?`: `boolean`; \}; `metadata?`: [`JsonObject`](contracts.md#jsonobject); `operationId`: `string`; `status`: `"failed"`; \}\>
...
[`ResourceProvider`](core.md#resourceprovider).[`invoke`](core.md#invoke)
...
- [`ToolNamespaceSettingsStore`](core.md#toolnamespacesettingsstore)
...
| Parameter | Type                                                                                         |
| --------- | -------------------------------------------------------------------------------------------- |
| `initial` | `Readonly`\<`Record`\<`string`, readonly [`ToolNamespace`](contracts.md#toolnamespace)[]\>\> |
...
[`ToolNamespaceSettingsStore`](core.md#toolnamespacesettingsstore).[`applyUpdate`](core.md#applyupdate)
...
| <a id="property-kernel"></a> `kernel`     | `readonly` | [`SharedOSKernel`](core.md#sharedoskernel)              | [testkit/src/index.ts:97](https://github.com/Aicoo-Team/SharedOS/blob/main/packages/testkit/src/index.ts#L97) |
...
> **ResourceHandler** = (`operation`) => `Promise`\<[`ResourceResult`](contracts.md#resourceresult)>\>
...
| Parameter   | Type                                                  |
| ----------- | ----------------------------------------------------- |
| `operation` | [`ResourceOperation`](contracts.md#resourceoperation) |

#### Returns

`Promise`\<[`ResourceResult`](contracts.md#resourceresult)\>
